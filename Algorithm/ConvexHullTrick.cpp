...
vector<long long> M; //Holds the slopes of the lines in the envelope, aka M[i]
vector<long long> B; //Holds the y-intercepts of the lines in the envelope, aka C[i]
